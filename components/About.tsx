    ...
    <MotionSection id="about" className="section-shell py-24">
      <div className="grid gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
        <SectionHeading
          ...
          body="AI導入で大切なのは、技術そのものよりも、誰が、いつ、どんな判断のために使うのかを理解すること。DMM生成AIエンジニアコース及びRootAIスクールでAIについて学び、RAGシステム・LP制作・画像生成・業務自動化ツールをメインにAIフリーランスとして活動を開始しました。ベーカリー経営の経験をもとに、現場の手触りを失わない業務改善を設計します。"
        />
